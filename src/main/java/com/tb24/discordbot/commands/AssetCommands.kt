...
private val DUMP_CLASS_REQUIREMENT = Predicate<CommandSourceStack> {
	it.channel.idLong == 736592991166136381L || it.author.idLong in arrayOf(624299014388711455L, 299693897859465228L, 129267551673909249L, 476930709227962389L, 373913699943186432L)
}
